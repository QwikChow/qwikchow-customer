...
class PaymentScreenState extends State<PaymentScreen> {
  ...
  payStackPayment(BuildContext context) async {
    String vendorId = widget.products.first.vendorID;
    VendorModel? vendor = await FireStoreUtils.getVendor(vendorId);
    String author = vendor!.author;

    NewUser? usersDetails = await FireStoreUtils.getUserByAuthorID(author);
