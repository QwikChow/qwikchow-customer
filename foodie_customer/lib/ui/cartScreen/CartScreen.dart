                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: tipValue == 100 && isTipSelected
                                  ? Color(COLOR_PRIMARY)
                                  : isDarkMode(context)
                                      ? const Color(DARK_COLOR)
                                      : const Color(0xffFFFFFF),
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            padding: const EdgeInsets.fromLTRB(15, 10, 15, 10),
                            decoration: BoxDecoration(
                              color: tipValue == 200 && isTipSelected1
                                  ? Color(COLOR_PRIMARY)
                                  : isDarkMode(context)
                                      ? const Color(DARK_COLOR)
                                      : const Color(0xffFFFFFF),
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            padding: const EdgeInsets.fromLTRB(15, 10, 15, 10),
                            decoration: BoxDecoration(
                              color: tipValue == 300 && isTipSelected2
                                  ? Color(COLOR_PRIMARY)
                                  : isDarkMode(context)
                                      ? const Color(DARK_COLOR)
                                      : const Color(0xffFFFFFF),
    ...
    return Expanded(
      child: Container(
        ...
        decoration: BoxDecoration(
          color: tipValue == 100 && isTipSelected
              ? Color(COLOR_PRIMARY)
              : tipValue == 200 && isTipSelected1
                  ? Color(COLOR_PRIMARY)
                  : tipValue == 300 && isTipSelected2
                      ? Color(COLOR_PRIMARY)
                      : Colors.white,
          borderRadius: BorderRadius.circular(8),
