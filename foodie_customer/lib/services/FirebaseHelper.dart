...
//start get user by vendorID

  static Future<NewUser?> getUserByAuthorID(String authorID) async {
DocumentSnapshot<Map<String, dynamic>> userDocument =
        await firestore.collection(USERS).doc(authorID).get();
    if (userDocument.data() != null && userDocument.exists) {
           return NewUser.fromJson(userDocument.data() as Map<String, dynamic>) ;
    } else {
      return null;
    }
  ...
  static Future<bool> sendFcmMessage(String type, String token) async {
    try {
      ...
      var header = {
        ...
        "Authorization":
            "key=AAAAirGxWR4:APA91bHr7ZhaiHtLQUVbhsGSvdeLUScqy9pAvsUcR__8Gel81nMDfNSrNWw3TYY80MfMqN-j7oPXBfZDhJ56WqWU5kvr_FwusLFm6uZgq3IisFesAKpumS8kASrvqSn83LTS_B5aMmyI",
      };
      var request = {
        "notification": {
